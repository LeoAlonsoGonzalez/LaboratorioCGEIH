...
int SCREEN_WIDTH, SCREEN_HEIGHT, i = 0;
...
int main( )
{
    ...
    // Load models
    Model ourModel((char*)"Models/silla_mesa2/Garden_Furniture.obj");
    Model ourModel2((char*)"Models/mesa_baja/CoffeeTable1.obj");
    /*Model ourModel3((char*)"Models/Fishes/TropicalFish08.obj");
    Model ourModel4((char*)"Models/Fishes/TropicalFish07.obj");
    Model models[4] = { ourModel, ourModel2, ourModel3, ourModel4 };*/
    // Draw in wireframe
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Draw the loaded model
        glm::mat4 model2(1);
        model2 = glm::translate(model2, glm::vec3(0.0f, -5.0f, 0.0f)); // Translate it down a bit so it's at the center of the scene
