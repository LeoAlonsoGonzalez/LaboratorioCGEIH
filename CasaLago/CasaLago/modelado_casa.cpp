...
int main()
{
	...
	Model ourModel5((char *)"Models/casa/villaF.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 model5(1);
		//se trasdala conforme x y z
		model5 = glm::translate(model5, glm::vec3(5.0f, -20.0f, 0.0f)); // Translate it down a bit so it's at the center of the scene2
		//LO escalamos de la misma forma que la traslación pero mas pequeño
		//model5 = glm::scale(model5, glm::vec3(0.4f, 0.4f, 0.4f));	// It's a bit too big for our scene, so scale it down
